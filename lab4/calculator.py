def calculator(num1, num2, operator):
    ...
    if operator == "+":
        ...
        if num1 == 0:
            print("dividing by zero is not permitted. process terminating...")
            return
        elif num2 == 0:
            print("dividing by zero is not permitted. process termintaing...")
            return
        else:
            result = num1 / num2
            print(f"The result is: {result}")
        ...
        print("the operator you require is invalid. process terminating...")
        return
